...
set xlabel "L at fixed g = 1" font ", 18"
set ylabel "Critical time at abs(T1 - T2) > Pi" font ",18"
#set format y "10^{%T}"
#set format x "10^{%T}"
...
plot 'CriticalTime.txt' using 4:1 with points pointtype 7 ps 0.5 lt rgb "black" title 'T1_0 = T2_0 = Pi/2, P1_0 = P2_0 = 0'
