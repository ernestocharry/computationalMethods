...
set xlabel "Omega at fixed g = 1" font ", 18"
...
plot 'CriticalTimeTheta2.txt' using 4:1 with points pointtype 7 ps 0.5 lt rgb "black" title 'T1_0 = T2_0 = Pi/2, P1_0 = P2_0 = 0'
