...
int main()
{
    ...
    int TercerZero = 3;
    xf = gsl_sf_bessel_zero_J0 (TercerZero);
    cout<<"\n Tercer zero de bessel de orden cero: "<<xf;
...
void GraficandoFuncion(double x0, double x1)
{
    ...
    fileFuncion.open("Funcion_J0.txt");
    ...
    {
        x = deltaX*i + x0;
        fileFuncion<<x<<"\t"<< gsl_sf_bessel_J0(x)<<"\n";
